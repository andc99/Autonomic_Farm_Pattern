...
fig, ax = plt.subplots()
sns.lineplot(x='Time', y='Service_Time', data=data, markers=True, ax=ax, color='black')
#data['Service_Time'].max()
#plt.ylim(ymax = 250, ymin = 25)
ax2 = ax.twinx()
sns.lineplot(x='Time', y='Degree', data=data, markers=True, ax=ax2, color='black', ls='--') # color='r')
